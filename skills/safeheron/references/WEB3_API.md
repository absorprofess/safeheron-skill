...
> ⚠️ **Web3 API requires a Web3 wallet account.** Use `accountType=WEB3_ACCOUNT` when querying accounts. Using a regular `VAULT_ACCOUNT` key will result in "account not found" errors.
